...
\begin{longtable}{|p{0.04\textwidth}|p{0.08\textwidth}|p{0.15\textwidth}|p{0.11\textwidth}|p{0.08\textwidth}|p{0.10\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|}
\hline
\textbf{ID} & \textbf{code} & \textbf{fullName} & \textbf{phoneNumber} & \textbf{email} & \textbf{dob} & \textbf{contractDate} & \textbf{restaurantID} \\
\hline
\endfirsthead
\hline
\textbf{ID} & \textbf{code} & \textbf{fullName} & \textbf{phoneNumber} & \textbf{email} & \textbf{dob} & \textbf{contractDate} & \textbf{restaurantID} \\
\hline
\endhead
1 & EMP001 & Nguyen Van An & 0901111111 & an@ & 2000-01-15 & 2025-09-01 & 1 \\
\hline
2 & EMP002 & Nguyen Van Binh & 0902222222 & binh@ & 2001-03-20 & 2025-10-01 & 1 \\
\hline
3 & EMP003 & Nguyen Van Cuong & 0903333333 & cuong@ & 1999-07-10 & 2025-08-15 & 1 \\
\hline
4 & EMP004 & Tran Thi Dao & 0904444444 & dao@ & 2002-11-05 & 2025-11-01 & 1 \\
\hline
5 & EMP005 & Le Hoang Em & 0905555555 & em@ & 2000-05-25 & 2026-01-10 & 1 \\
\hline
...
\begin{longtable}{|p{0.06\textwidth}|p{0.18\textwidth}|p{0.13\textwidth}|p{0.14\textwidth}|p{0.14\textwidth}|p{0.10\textwidth}|p{0.09\textwidth}|}
\hline
\textbf{ID} & \textbf{registeredTime} & \textbf{status} & \textbf{description} & \textbf{employeeID} & \textbf{shiftID} & \textbf{userID} \\
\hline
\endfirsthead
\hline
\textbf{ID} & \textbf{registeredTime} & \textbf{status} & \textbf{description} & \textbf{employeeID} & \textbf{shiftID} & \textbf{userID} \\
\hline
\endhead
1 & 2026-05-15 09:00 & confirmed & & 1 & 1 & 1 \\
\hline
2 & 2026-05-15 09:00 & confirmed & & 1 & 3 & 1 \\
\hline
3 & 2026-05-15 09:30 & confirmed & & 2 & 2 & 1 \\
\hline
4 & 2026-05-15 09:30 & confirmed & & 2 & 5 & 1 \\
\hline
5 & 2026-05-15 09:30 & confirmed & & 2 & 7 & 1 \\
\hline
6 & 2026-05-15 09:30 & confirmed & & 2 & 10 & 1 \\
\hline
...
\hline
\endhead
1 & Start the application. & The system displays the login interface. \\
\hline
2 & Enter username \texttt{staff01}, password \texttt{staff01}, and click the login button. & The system validates the account and displays the Registration Staff home interface. The home interface contains the \textit{Register for next week} function. \\
\hline
3 & Click the \textit{Register for next week} function. & The system displays the search employee interface. \\
\hline
4 & Enter the keyword \texttt{Nguyen Van} and click the search button. & The system displays three matching employees: Nguyen Van An, Nguyen Van Binh, and Nguyen Van Cuong. \\
\hline
5 & Select the row of Nguyen Van Cuong. & The system displays the register shift interface for Nguyen Van Cuong. The next-week shift table is displayed with all checkboxes unchecked because this employee has no registration yet. \\
\hline
6 & Tick Monday Shift 2, Tuesday Shift 1, Thursday Shift 1, Thursday Shift 2, and Friday Shift 2. & The system shows that five shifts are selected. \\
\hline
7 & Click the save button. & The system validates the selected shifts. The total number of selected shifts is five, and five is greater than or equal to the minimum threshold of four shifts per week. \\
\hline
8 & Confirm the save action. & The system saves the registration records and displays the message \textit{Registration saved successfully!}. \\
\hline
9 & Click OK on the success message. & The system returns to the Registration Staff home interface. \\
\hline
...
6 & 2026-05-15 09:30 & confirmed & & 2 & 10 & 1 \\
\hline
7 & 2026-05-16 10:15 & confirmed & & 3 & 2 & 1 \\
\hline
8 & 2026-05-16 10:15 & confirmed & & 3 & 3 & 1 \\
\hline
9 & 2026-05-16 10:15 & confirmed & & 3 & 7 & 1 \\
\hline
10 & 2026-05-16 10:15 & confirmed & & 3 & 8 & 1 \\
\hline
11 & 2026-05-16 10:15 & confirmed & & 3 & 10 & 1 \\
\hline
