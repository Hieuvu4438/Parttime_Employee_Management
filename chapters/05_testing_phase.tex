...
\hline
\endhead
1. Start the application. & The login interface appeared with: a text field for entering username; a text field for entering password; and a Login button. \\
\hline
2. Enter username = \texttt{staff01}, password = \texttt{staff01}, and click on the Login button. & The home interface of the registration staff appeared with User's name: ``Registration Staff'' and a button: Register for next week. \\
\hline
3. Click on the Register for next week button. & The search employee interface appeared with: a text field to enter keyword (employee name); a Search button; and an empty result table. \\
\hline
4. Enter keyword = \texttt{Nguyen Van} and click on the Search button. & Three employees appeared in the result table: \newline 1 -- EMP001 -- Nguyen Van An -- 0901111111 \newline 2 -- EMP002 -- Nguyen Van Binh -- 0902222222 \newline 3 -- EMP003 -- Nguyen Van Cuong -- 0903333333. \\
\hline
5. Click on the row of Nguyen Van Cuong (row 3). & The register shift interface appeared with employee information: Code = EMP003, Name = Nguyen Van Cuong, Phone = 0903333333. The shift registration table was displayed with all checkboxes unchecked for Monday to Sunday, including Shift 1 (8am--4pm) and Shift 2 (4pm--12am), and a Save button. \\
\hline
6. Tick the following checkboxes: Monday Shift 2, Tuesday Shift 1, Thursday Shift 1, Thursday Shift 2, and Friday Shift 2 (total = 5 shifts), then click on the Save button. & The system validates: total registered shifts (5) $\geq$ minimum threshold (4). A message appeared: ``Registration saved successfully!'' \\
\hline
7. Click on the OK button of the message. & Return to the home interface of the registration staff. \\
\hline
