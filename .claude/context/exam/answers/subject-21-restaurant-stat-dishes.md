...
|------|-----------|---------------------|
| 1 | Manager mở ứng dụng. Giao diện Login xuất hiện: ô nhập username, password, nút Login. | **LoginFrm** |
| 2 | Manager nhập username `manager01`, password `******`, nhấn Login. | **LoginFrm** |
| 3 | Hệ thống xác thực thành công. Giao diện Home xuất hiện với menu Statistics. | **HomeFrm** |
| 4 | Manager chọn menu **Statistics** → **Dishes statistics**. | **HomeFrm** |
| 5 | Giao diện thống kê **DishStatFrm** xuất hiện: ô nhập ngày bắt đầu, ô nhập ngày kết thúc, nút Statistics. | **DishStatFrm** |
| 6 | Manager nhập ngày bắt đầu: 01/01/2026, ngày kết thúc: 31/12/2026. | **DishStatFrm** |
| 7 | Manager nhấn nút **Statistics**. | **DishStatFrm** |
| 8 | Hệ thống hiển thị bảng kết quả: mã món, loại món, tên món, tổng số lượng bán, tổng doanh thu, sắp xếp giảm dần theo doanh thu. Dữ liệu: D001 Món chính Phở bò (4 bán, 200,000đ); D002 Món chính Bún bò (3 bán, 165,000đ); D003 Thức uống Coca Cola (10 bán, 150,000đ); D004 Tráng miệng Chè đậu (4 bán, 80,000đ). | **DishStatFrm** — bảng thống kê |
| 9 | Manager nhấn vào dòng "Phở bò" (D001). | **DishStatFrm** |
| 10 | Hệ thống hiển thị chi tiết các lần đặt Phở bò: HD001 Nguyễn Văn A, 15/03/2026 11:30, 2, 100,000đ; HD002 Trần Thị B, 18/03/2026 12:15, 1, 50,000đ; HD004 Phạm Thị D, 05/04/2026 19:00, 1, 50,000đ. | **DishStatFrm** — bảng chi tiết |
| 11 | Manager nhấn **Back**. Quay về bảng thống kê món ăn. | **DishStatFrm** — bảng thống kê |
| 12 | Manager nhấn Logout. Quay về giao diện Login. | **LoginFrm** |

### Kịch bản ngoại lệ

| Mã | Tình huống | Diễn biến |
|----|-----------|-----------|
| EL1 | Không có đơn hàng nào trong khoảng thời gian | Bảng thống kê trống, thông báo "Khong co du lieu trong khoang thoi gian nay". |
| EL2 | Ngày bắt đầu lớn hơn ngày kết thúc | Hệ thống cảnh báo "Ngay bat dau phai truoc ngay ket thuc". |
| EL3 | Manager nhấn Statistics khi chưa nhập ngày | Hệ thống cảnh báo "Vui long nhap khoang thoi gian". |
...
| Table | id (PK), code, name, maxGuests, description |
...
| Table | <<entity>> | -id: int, -code: String, -name: String, -maxGuests: int, -description: String | (không có) |
...
| No. | Module | Test case |
|-----|--------|-----------|
| TC01 | Statistics of dishes | Thống kê món ăn có dữ liệu đầy đủ, xem chi tiết lần đặt |
| TC02 | Statistics of dishes | Thống kê với khoảng thời gian không có dữ liệu |
| TC03 | Statistics of dishes | Thống kê với khoảng thời gian ngắn (1 ngày) |
| TC04 | Statistics of dishes | Nhập ngày bắt đầu > ngày kết thúc |
| TC05 | Statistics of dishes | Thống kê khi có combo trong đơn hàng |

### TC01: Thống kê món ăn và xem chi tiết lần đặt

**Purpose:** Kiểm tra chức năng thống kê món ăn hiển thị đúng tổng số lượng bán, tổng doanh thu, và chi tiết lần đặt món khi có dữ liệu đầy đủ.
...
**Purpose:** Kiểm tra hệ thống hiển thị thông báo phù hợp khi không có đơn hàng nào trong khoảng thời gian chọn.

**Database trước khi test:**
- Sử dụng cùng database với TC01. Không có đơn hàng nào trong khoảng 01/06/2025 - 30/06/2025.
